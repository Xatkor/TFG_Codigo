...
def main():
    ...
    # Distance of walls
    # -------------------------------------
    top_wall_distance = 1001
    bottom_wall_distance = 1
    left_wall_distance = 1
    right_wall_distance = 1001
    ...
    left_wall_velocity = np.array([0.01, 0], dtype=np.float64)
    right_wall_velocity = np.array([-0.01, 0], dtype=np.float64)
