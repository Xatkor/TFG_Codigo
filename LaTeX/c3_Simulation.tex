...
\newpage
\textcolor{red}{¿Simulaciones incorrectas? ¿Deberían ser llegar a la línea discontínua?}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{images/Simulaciones/Inelastico_2D/2D_A-N1000.pdf}
    \caption{$\epsilon = 0.99$}
    \label{fig:2D_A_ine-N1000}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{images/Simulaciones/Inelastico_2D/2D_A3-N1000.pdf}
    \caption{$\epsilon = 0.8$}
    \label{fig:2D_A_ine-N1000}
\end{figure}
