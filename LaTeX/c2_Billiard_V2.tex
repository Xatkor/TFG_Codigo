...
Como se ha podido ver tras cada colisión \cambios{la velocidad de la partícula cambiará su valor o no}. La pregunta que surge es para que casos podemos decir que la velocidad va a aumentar y para cuales disminuirá. Además es interesante estudiar cuál es el límite de esta velocidad. 

\vspace{3mm}

Vamos a suponer que estamos en el espacio de una dismensión con dos paredes que móviles con una misma velocidad pero sentidos opuestos, esto es, si una se desplaza a la derecha la otra lo hará a la izquierda. \cambios{Tras cada colisión la velocidad de la partícula cambiará de la forma}
...
Hasta ahora se ha supuesto que la colisión es totalmente elástica y no existe pérdida de energía tras cada colisión, lo que ocasiona que pueda existir la aceleración de Fermi. Vamos a suponer que tras cada colisión la velocidad de la partícula, en un sistema donde la pared está en reposo, es modificada de acuerdo a 
...
que si usamos \( \epsilon = 1 \) como en una colisión totalmente elástica recuperamos la expresión \ref{eq:velocidad_paralela}
